...
from apps.utils.sendmail_utils import *
from apps.utils.other_func import *

from apps.product_docs.models import InstallDoc


# from apps.record.models import FaultRecord
        ...
        if keywords != '':
            all_users = all_users.filter(
                Q(username__icontains=keywords) | Q(nick_name__icontains=keywords) | Q(email__icontains=keywords) | Q(
                    ...
                    desc__icontains=keywords) | Q(department__name__icontains=keywords) | Q(
                    position__name__icontains=keywords))
