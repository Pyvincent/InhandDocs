...
class UserProfile(AbstractUser):
    ...
    department = models.ForeignKey(UserDepartment, verbose_name='部门', blank=True, null=True, on_delete=models.CASCADE)
    position = models.ForeignKey(UserPosition, verbose_name='职位', blank=True, null=True, on_delete=models.CASCADE)
    ...
    #     from apps.message.models import UserMessage, UserReadMessage
